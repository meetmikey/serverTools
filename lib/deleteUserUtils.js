        ...
        async.each( foundAttachments, function( attachment, eachCallback ) {
          ...
          AttachmentModel.findOneAndRemove( filter, function( mongoErr ) {
            if ( mongoErr ) {
              ...
              deleteUserUtils.checkAndDeleteAttachmentAndAttachmentInfo( attachment, function(err) {
                if ( err ) {
                  eachCallback( err );
...
exports.checkAndDeleteAttachmentAndAttachmentInfo = function( attachment, callback ) {
